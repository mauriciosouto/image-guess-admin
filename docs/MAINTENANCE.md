...
| Code change | Update |
|-------------|--------|
| `prisma/schema.prisma`, `app/api/puzzles/*` routes, home bulk-create UI | `PUZZLE_SYSTEM.md`, `project_content.md`, API table in `README.md` |
...
| `lib/puzzle/deterministicStep.ts` | `ZONES_FAB.md`, `PUZZLE_SYSTEM.md`, `EFFECTS_SYSTEM.md` |
...
| `lib/puzzle/generateRegions.ts` | `PUZZLE_SYSTEM.md`, `ZONES_FAB.md` |
...
| `app/puzzles/[id]/*` (page, tile, hydration) | `PUZZLE_SYSTEM.md`, `ARCHITECTURE.md` if RSC/client pattern changes |
